...
client.poll();
    ...
    client.send("{\"type\":\"getList\",\"type2\":\"1234\",\"username\":\"esp\"}");    
    kontrol2 = 1;
    }
   ...
   /* if (kontrol == 0) {
      ...
      kontrol = 1;
      Serial.println("Websocket Connected! json");
      client.send("{\"type\":\"getList\",\"type2\":\"query\",\"username\":\"esp\",\"password\":\"thWUFzNEN5wWRW9\",\"relayNo\":\"1\"}");
      while (!client.connect(websocket_server_host, websocket_server_port, "/")) {
    delay(500);
    Serial.print(".");
  }
