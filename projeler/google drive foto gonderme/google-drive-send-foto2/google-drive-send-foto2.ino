...
https://www.youtube.com/watch?v=jW90KK1_Xtc&ab_channel=fuchungyi
https://github.com/fustyles/Arduino/tree/master/ESP32-CAM_PIR_GoogleDrive_Linenotify
https://github.com/fustyles/webduino/blob/gs/SendCapturedImageToGoogleDriveAndLinenotify_doPost.gs
https://www.youtube.com/watch?v=f46VBqWwUuI&ab_channel=fuchungyi

ESP32 WROVER MODULE-HUGE APP
*/

// Enter your WiFi ssid and password
const char* ssid     = "Enelsis3";   //your network SSID
const char* password = "1vn6egph";   //your network password
int gpioPIR = 13;   //PIR Motion Sensor

const char* myDomain = "script.google.com";
String myScript = "/macros/s/AKfycbwSGPHDTOsyiv2Jjx70NBIGROb6CZIP984qTYViYYCZbTY2KLTfbsDgs9y9r63qMKkIHw/exec";    //Create your Google Apps Script and replace the "myScript" path.
