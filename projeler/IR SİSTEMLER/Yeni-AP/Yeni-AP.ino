...
/*
 * oksijen(mikrodenetleyicedeki oksijen ucunu oksijen motoun GND'sine, oksijen motorun + 12 volta bagla)
 * motor (mikrodenetleyicedeki motor ucunu rolenin bir ucuna, rolenin diger ucunu 12 volta)  (rolenin diger bacaginda motorun kendi kablosunu kes bir ucunu bi yere bi ucunu kablonun diger yerine tak)
 * +(guc kaynaginin 5 voltuna)
 */
