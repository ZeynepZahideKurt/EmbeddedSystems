...
void receive_() {
  ...
  if (GPO3_L()) {
    ...
    if (tmp) {
      ...
      String reset_eeprom = mystring.substring(10, 13);
      ...
      Serial.println(rx_buf[9]);
      Serial.println(rx_buf[20]);
      if (rx_buf[9] == 'A' && rx_buf[20] == 'B') {
        Serial.println("giriyor2");
