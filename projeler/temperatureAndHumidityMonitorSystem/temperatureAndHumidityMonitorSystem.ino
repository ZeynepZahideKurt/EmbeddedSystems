...
display(6, "ENELSIS", RIGHT, 0);
  // display(7, buf, LEFT, 1);

  //

  //displayLogo();
  // display(7, bufnem, RIGHT, 1);
  //display(3, "MERHABAMERHABAMERHABA", LEFT, 1);

  // display(7, "MERHABA", LEFT, 1);
  //display(5, "SELAM", CENTER,1);
  //display(3, "SAG", RIGHT,1);
  //display(7, buf, CENTER, 1);
}
